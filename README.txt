PHP4/5用ＱＲコードクラスライブラリ ver. 0.50beta12   (c)2002-2009 Y.Swetake
----------
０、概要
...
　ご意見・不具合などあれば下記まで
　　e-mail: swe[あっとマーク]venus.dti.ne.jp


７、更新履歴

    2009/11/10   ver.0.50beta12
              preg_match関数の中の正規表現記載ミスを修正した。

    2009/11/8    ver.0.50beta11
              PHP5.3.0から非推奨となったereg関数をpreg_match関数に書き換えた。
              なお、以前のereg関数で"-"がうまくマッチせず、エンコードモードの自動判別が
              誤っていた不具合もpreg_matchに変更することにより解消した。
